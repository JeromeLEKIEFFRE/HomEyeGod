...
<br/>
<p>La validation de la souscription est considérée comme définitive à compter de l’envoi au Client, de la confirmation de souscription par le Prestataire, par courrier électronique. Le courrier électronique de confirmation est envoyé à l’adresse électronique renseignée par le Client lors de la création de son compte personnel. Il appartient au Client de vérifier l’exactitude de la souscription et de signaler immédiatement toute erreur au Service Support Client (article 8.2).</p>
<br/>
...
<br/>
<p>Le Service est fourni dès validation définitive de la souscription par le Prestataire. La responsabilité du Prestataire ne pourra en aucun cas être engagée en cas de retard ou de suspension de la fourniture du Service imputable au Client ou consécutif à la survenance d’un cas de force majeure habituellement reconnu par le Code civil et la jurisprudence française. Le Prestataire garantit, conformément aux dispositions légales, le Client, contre tout défaut de conformité du Service et tout vice caché, provenant d’un défaut de conception ou de fourniture dudit Service à l’exclusion de toute négligence ou faute du Client. Le Prestataire remboursera ou rectifiera ou fera rectifier dans la mesure du possible le Service jugé défectueux dans les meilleurs délais. En tout état de cause, au cas où la responsabilité du Prestataire serait retenue, la responsabilité du Prestataire serait limitée au montant effectivement payé par le Client pour la fourniture du Service.</p>
<br/>
<h2>ARTICLE 7 – INFORMATIQUES ET LIBERTÉS</h2>
<br/>
<p>En application de la loi 78-17 du 6 janvier 1978, il est rappelé que les données nominatives qui sont demandées au Client sont nécessaires au traitement de sa souscription, à l’établissement des factures ainsi qu’au traitement des éventuelles réclamations. Ces données peuvent être communiquées aux éventuels partenaires du Prestataire chargés de l’exécution, du traitement, de la gestion et du paiement des souscriptions. Le Prestataire s’est acquitté des formalités relatives au traitement des informations personnelles des Clients qui sont communiquées par l’intermédiaire du site Internet du Prestataire ou de ses applications. Le Client dispose, conformément aux réglementations nationales et européennes en vigueur d’un droit d’accès permanent, de modification, de rectification et d’opposition s’agissant des informations le concernant. Ce droit peut être exercé dans les conditions et selon les modalités précisées dans la Politique de Confidentialité du Prestataire. Par ailleurs, il appartient exclusivement au Client de mettre en œuvre les modalités utiles afin de préserver la confidentialité des informations qu’il communique sur le réseau Internet.</p>
<p>Tout accès au Service effectué à partir de l’identifiant du Client est réputé faite par le Client lui-même. Les mots de passe et identifiants sont personnels et le Client s’engage à ne pas les divulguer. À ce titre, le Prestataire ne peut être tenue responsable de l’utilisation des identifiants et du mot de passe du Client par un tiers auquel le Client les aurait communiqué ou bien qui y aurait eu accès suite à une faute, maladresse ou négligence de la part du Client. Le Client doit informer immédiatement le Prestataire de toute utilisation non-autorisée de son compte, de ses identifiants et mot de passe. En cas de perte ou d’oubli de son mot de passe, le Client est invité à cliquer sur le lien « mot de passe oublié » qui est disponible chaque fois que la saisie de ses identifiants de connexion est requise. La marche à suivre est alors indiquée. Le mot de passe sera alors renvoyé à l’adresse mail renseigné par le client. Il est ensuite conseillé de le changer pour éviter la reproduction du même accident.</p>
<br/>
...
<br/>
<h2>ARTICLE 10 - INFORMATION PRÉCONTRACTUELLE ET ACCEPTATION DU CLIENT</h2>
<br/>
